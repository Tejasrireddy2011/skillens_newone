...
import { WebdevelopmentAngularRoutingModule } from './webdevelopment-angular-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    WebdevelopmentAngularRoutingModule,
    SharedModule,
    NgbModule
  ]
})
export class WebdevelopmentAngularModule { }
