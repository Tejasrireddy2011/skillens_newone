...
import { WebdevelopmentReactjsRoutingModule } from './webdevelopment-reactjs-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    WebdevelopmentReactjsRoutingModule,
    SharedModule,
    NgbModule
  ]
})
export class WebdevelopmentReactjsModule { }
